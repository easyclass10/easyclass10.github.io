...
(function() {
  ...
  scan_stmt = function() {
    var ac, ad, assignmentIsOfQuotedType, existingDependencies, i, indexOfSymbolLeftOfAssignment, len, len1, symbolLeftOfAssignment;
    scan_relation();
  ...
  runUserDefinedSimplifications = function() {
    var ac, ad, atLeastOneSuccessInRouldOfRulesApplications, eachConsecutiveRuleApplication, eachSimplification, len, len1, numberOfRulesApplications, originalexpanding, success;
    if (userSimplificationsInListForm.length !== 0 && !Find(cadr(p1), symbol(INTEGRAL))) {
      ...
      for (ac = 0, len = userSimplificationsInListForm.length; ac < len; ac++) {
        eachSimplification = userSimplificationsInListForm[ac];
        if (DEBUG) {
      ...
      while (atLeastOneSuccessInRouldOfRulesApplications && numberOfRulesApplications < MAX_CONSECUTIVE_APPLICATIONS_OF_ALL_RULES) {
        ...
        for (ad = 0, len1 = userSimplificationsInListForm.length; ad < len1; ad++) {
          eachSimplification = userSimplificationsInListForm[ad];
          success = true;
  ...
  transform = function(s, generalTransform) {
    var ac, ad, ae, bookmarkTosToPrintDecomps, eachTransformEntry, i, len, len1, numberOfDecomps, ref1, restTerm, secondTerm, success, theTransform, transform_h, transformationSuccessful, transformedTerms;
    transform_h = 0;
    save();
    p1 = null;
    p4 = pop();
    ...
    if (DEBUG) {
      ...
      for (i = ac = 0, ref1 = numberOfDecomps; 0 <= ref1 ? ac < ref1 : ac > ref1; i = 0 <= ref1 ? ++ac : --ac) {
      ...
      if (!isnum(p3)) {
        ...
        if (f_equals_a(transform_h, generalTransform)) {
          ...
          if (transformedTerms.length !== 0) {
            for (ad = 0, len = transformedTerms.length; ad < len; ad++) {
              i = transformedTerms[ad];
              push(i);
            }
  ...
  test_dependencies = function() {
    ...
    if (testResult[0] === "All local dependencies: . Symbols with reassignments: . All dependencies recursively: " && testResult[1] === "1" && testResult[2] === "") {
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: x, g, ;  variable g depends on: f, ;  variable h depends on: g, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: x, ;  f --> g -->  ... then f again,  variable g depends on: x, ;  g --> f -->  ... then g again,  variable h depends on: x, ;  h --> g --> f -->  ... then g again, " && testResult[1] === "" && testResult[2] === "// f is part of a cyclic dependency, no code generated.\n// g is part of a cyclic dependency, no code generated.\n// h is part of a cyclic dependency, no code generated.") {
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: y, ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: y, ; " && testResult[1] === "" && testResult[2] === "x = function (y) { return ( Math.pow(y, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: ; " && testResult[1] === "" && testResult[2] === "x = -1/2*Math.pow(2, (1/2));") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: a, ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: a, ; " && testResult[1] === "" && testResult[2] === "x = function (a) { return ( 1/10*Math.pow(2, (1/2)) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: t, y, ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: t, y, ; " && testResult[1] === "" && testResult[2] === "x = function (t, y) { return ( t*y*(6*Math.pow(t, 2) + Math.pow(y, 2) + 6*t*y) / ((t + y)*Math.pow((2*t + y), 2)) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: a, b, c, d, ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: a, b, c, d, ; " && testResult[1] === "" && testResult[2] === "x = function (a, b, c, d) { return ( Math.pow((Math.pow(a, 2) + Math.pow(b, 2)), (1/2)) / (Math.pow((Math.pow(c, 2) + Math.pow(d, 2)), (1/2))) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: y, ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: y, ; " && testResult[1] === "" && testResult[2] === "x = function (y) { return ( 1 + y ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: ; . Symbols with reassignments: . All dependencies recursively:  variable x depends on: ; " && testResult[1] === "" && testResult[2] === "x = 1;") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: 'x, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: 'x, ; " && testResult[1] === "" && testResult[2] === "f = function (x) { return ( x*x ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: 'x, g, y, ; " && testResult[1] === "" && testResult[2] === "f = function (x, g, y) { return ( g(y) + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable y depends on: ;  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . All dependencies recursively:  variable y depends on: ;  variable f depends on: 'x, g, ; " && testResult[1] === "" && testResult[2] === "y = 2;\nf = function (x, g) { return ( g(2) + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable g depends on: 'x, ;  variable y depends on: ;  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . All dependencies recursively:  variable g depends on: 'x, ;  variable y depends on: ;  variable f depends on: 'x, ; " && testResult[1] === "" && testResult[2] === "g = function (x) { return ( 2 + x ); }\ny = 2;\nf = function (x) { return ( 4 + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    do_clearall();
    testResult = findDependenciesInScript('g(x) = x + 2\nf(x) = x * x + g(y)');
    if (testResult[0] === "All local dependencies:  variable g depends on: 'x, ;  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . All dependencies recursively:  variable g depends on: 'x, ;  variable f depends on: 'x, y, ; " && testResult[1] === "" && testResult[2] === "g = function (x) { return ( 2 + x ); }\nf = function (x, y) { return ( 2 + y + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, b, c, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: a, b, c, ; " && testResult[1] === "" && testResult[2] === "f = function (a, b, c) { return ( [-1/2*(Math.pow((Math.pow(b, 2) / (Math.pow(a, 2)) - 4*c / a), (1/2)) + b / a),1/2*(Math.pow((Math.pow(b, 2) / (Math.pow(a, 2)) - 4*c / a), (1/2)) - b / a)] ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, b, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: a, b, ; " && testResult[1] === "" && testResult[2] === "f = function (a, b) { return ( [0,-2*b / a] ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: a, ; " && testResult[1] === "" && testResult[2] === "f = function (a) { return ( -1 / (2*a) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: a, ; " && testResult[1] === "" && testResult[2] === "f = function (a) { return ( -1 / a ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: y, ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: y, ; " && testResult[1] === "" && testResult[2] === "f = function (y) { return ( -2*Math.pow(y, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: ; . Symbols with reassignments: . All dependencies recursively:  variable f depends on: ; " && testResult[1] === "" && testResult[2] === "f = 55;") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable a depends on: ;  variable f depends on: 'a, b, ; . Symbols with reassignments: . All dependencies recursively:  variable a depends on: ;  variable f depends on: 'a, b, ; " && testResult[1] === "" && testResult[2] === "a = 2;\nf = function (a, b) { return ( 1 + a + b ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    do_clearall();
    testResult = findDependenciesInScript('a = 2\nf = a+1');
    if (testResult[0] === "All local dependencies:  variable a depends on: ;  variable f depends on: a, ; . Symbols with reassignments: . All dependencies recursively:  variable a depends on: ;  variable f depends on: ; " && testResult[1] === "" && testResult[2] === "a = 2;\nf = 3;") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable a depends on: b, ;  variable f depends on: a, ; . Symbols with reassignments: . All dependencies recursively:  variable a depends on: b, ;  variable f depends on: b, ; " && testResult[1] === "" && testResult[2] === "a = function (b) { return ( b ); }\nf = function (b) { return ( 1 + b ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    do_clearall();
    testResult = findDependenciesInScript('a := b\nf(a) = a+1');
    if (testResult[0] === "All local dependencies:  variable a depends on: b, ;  variable f depends on: 'a, ; . Symbols with reassignments: . All dependencies recursively:  variable a depends on: b, ;  variable f depends on: 'a, ; " && testResult[1] === "" && testResult[2] === "a = function (b) { return ( b ); }\nf = function (a) { return ( 1 + a ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable b depends on: a, c, ; . Symbols with reassignments: b, . All dependencies recursively:  variable b depends on: a, c, ; " && testResult[1] === "" && testResult[2] === "b = function (a, c) { return ( 1 + a + c ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable a depends on: ; . Symbols with reassignments: a, . All dependencies recursively:  variable a depends on: ; " && testResult[1] === "" && testResult[2] === "" && testResult[5] === "Error: Stop: recursive evaluation of symbols: a -> a") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
  ...
  findDependenciesInScript = function(stringToBeParsed, dontGenerateCode) {
    var ae, af, ag, ah, aj, al, allReturnedPlainStrings, am, bodyForReadableSummaryOfGeneratedCode, cyclesDescriptions, deQuotedDep, dependencyInfo, eachDependency, error, error1, error2, error3, generatedBody, generatedCode, i, indexOfPartRemainingToBeParsed, inited, key, len, len1, len2, len3, len4, len5, len6, n, parameters, readableSummaryOfGeneratedCode, recursedDependencies, scriptEvaluation, testableString, toBePrinted, value, variablesWithCycles;
    if (DEBUG) {
    ...
    if (errorMessage === "" && !dontGenerateCode) {
      ...
      if (errorMessage === "") {
        for (key in symbolsDependencies) {
          ...
          for (ag = 0, len2 = variablesWithCycles.length; ag < len2; ag++) {
            i = variablesWithCycles[ag];
            if (DEBUG) {
              console.log("		--> cycle through " + i);
            }
          }
          for (ah = 0, len3 = recursedDependencies.length; ah < len3; ah++) {
            i = recursedDependencies[ah];
            if (DEBUG) {
              console.log("		" + i);
            }
            testableString += i + ", ";
          ...
          testableString += "; ";
          for (aj = 0, len4 = cyclesDescriptions.length; aj < len4; aj++) {
            i = cyclesDescriptions[aj];
            testableString += " " + i + ", ";
          }
          if (DEBUG) {
          ...
          for (al = 0, len5 = recursedDependencies.length; al < len5; al++) {
            eachDependency = recursedDependencies[al];
            if (eachDependency[0] === "'") {
              if (DEBUG) {
  ...
  run = function(stringToBeRun, generateLatex) {
    ...
    if (ENABLE_CACHING && stringToBeRun !== "clearall" && !errorWhileExecution) {
      ...
      if (CACHE_DEBUGS) {
        console.log("setting cache on key: " + cacheKey);
      }
  ...
  computeResultsAndJavaScriptFromAlgebra = function(codeFromAlgebraBlock) {
    var ae, code, dependencyInfo, i, keepState, latexResult, len, readableSummaryOfCode, ref2, result, testableStringIsIgnoredHere, timeStartFromAlgebra, userSimplificationsInProgramForm;
    keepState = true;
  ...
  resetCache = function() {
    if (cached_runs != null) {
      cached_runs.reset();
      if (DEBUG) {
        return console.log("resetting cache");
      }
    }
  };
